...
for loop, it's possible zero may regain the lock before other threads wake up. In that case, other threads will have to keep waiting until the lock can be acquired.
